<# 
    ...
    .EXAMPLE     
        PS C:\> Rename-Pictures C:\Folder\Pics\  
    ...
    .NOTES 
        ...
        Image Size Added by Magnus Sandström - gorillanajs@gmail.com
#>
    ...
    { 
        ...
        If ($ImgsFound.Count -gt 0) {         
            ...
            { 
                ...
                # Gets the image size
                $imageSize = (Get-Item -Path $Img.FullName).Length
               ...
               # [string]$NewFileName = $dateTaken + "_" + $ImgDimensions + [System.IO.Path]::GetExtension($Img.Name)
                [string]$NewFileName = $dateTaken + "_" + $ImgDimensions + "_" + $imageSize + [System.IO.Path]::GetExtension($Img.Name)
